...
const ExerciseDetailScreen = () => {
  ...
  // Nhận maKeHoach và planTitle từ Home gửi sang
  ...
  // 1. Khởi tạo ref là null
  const startTimeRef = useRef<Date | null>(null);
  // 2. State để biết khi nào đã load xong thời gian từ storage
  const [isTimerReady, setIsTimerReady] = useState(false);

  // 3. Load thời gian khi vào màn hình
  useEffect(() => {
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            ...
            const totalMinutes = Math.floor(diffMs / 60000) || 1;
